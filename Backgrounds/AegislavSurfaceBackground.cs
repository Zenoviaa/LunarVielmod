...
public partial class AegislavUndergroundBackground : CustomBG
{
    ...
    {
        base.SetStaticDefaults();
        _farTextureAsset = AssetManager.LoadBackground("AegislavUnderground_Far");
    }
    public override void Unload()
    {
        base.Unload();
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        Vector2[] parallax = new Vector2[1];
        ...
        {
            SpritebatchDrawer drawer = SpritebatchDrawer.FromTextureAsset(_farTextureAsset, Main.screenPosition);
