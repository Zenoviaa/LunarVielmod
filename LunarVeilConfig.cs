...
namespace Stellamod
{
	public class LunarVeilConfig : ModConfig
	{
		...
		[Header("Replace Vanilla Textures")] // Headers are like titles in a config. You only need to declare a header on the item it should appear over, not every item in the category. 
