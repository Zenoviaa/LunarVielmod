...
{
    public class SirestiasSparkleAlphaParticle : Particle<SirestiasSparkleAlphaParticle>
    {
        public int FrameWidth = 128;
        public int FrameHeight = 128;
        public int MaxFrameCount = 4;
    ...
    public class SirestiasSparkleParticle : Particle<SirestiasSparkleParticle>
    {
        public int FrameWidth = 128;
        public int FrameHeight = 128;
        public int MaxFrameCount = 4;
