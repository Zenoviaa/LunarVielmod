...
namespace Stellamod.NPCs.Overworld.RoyalSlime
{
	...
	public class RoyalSlime : ModNPC
	{
        ...
        {
            return (Main.dayTime && spawnInfo.Player.ZoneOverworldHeight && !spawnInfo.Player.ZoneBeach && !spawnInfo.Player.ZoneJungle && !spawnInfo.Player.ZoneDesert && !spawnInfo.Player.ZoneSnow && !spawnInfo.Player.ZoneCrimson && !spawnInfo.Player.ZoneSkyHeight && !EventWorld.Gintzing ? (0.40f) : 0f);
        }
