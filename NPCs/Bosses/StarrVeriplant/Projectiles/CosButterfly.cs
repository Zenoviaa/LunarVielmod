    ...
    public class CosButterfly : ModProjectile
	{
        ...
        public override void OnKill(int timeLeft)
        {
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedXabx, Projectile.position.Y + speedYabx, speedXabx * 0, speedYabx * 0,
                    ProjectileID.DaybreakExplosion, Projectile.damage * 0, 0f, Owner: Projectile.owner);
            }
        }
