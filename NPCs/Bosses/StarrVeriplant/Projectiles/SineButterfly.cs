...
{
	public class SineButterfly : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Butterfly of death");
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (float i = 0f; i < 1f; i += 0.25f)
			{
				...
				Main.EntitySpriteDraw(texture, drawPos + new Vector2(0f, 8f).RotatedBy(radians) * time, frame, new Color(225, 170, 25, 50), Projectile.rotation, frameOrigin, Projectile.scale, SpriteEffects.None, 0);
			}
