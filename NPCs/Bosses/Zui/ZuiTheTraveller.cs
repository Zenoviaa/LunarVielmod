    ...
    public class ZuiTheTraveller : ModNPC
    {
        ...
        private void BeamsZui()
        {
            ...
            if (timer == 40)
            {
                if (StellaMultiplayer.IsHost)
                {
                    int index2 = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<ZuiLASERWARN>());
        ...
        private void RunningZuiRight()
        {
            ...
            if (timer == 1)
            {
                if (StellaMultiplayer.IsHost)
                {
                    ...
                    Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center + new Vector2(150, 150), velocity * 0, ModContent.ProjectileType<ZuiSpawnEffect>(), 0, 10, Main.myPlayer, ai0: NPC.whoAmI);
        ...
        private void HomeRunZui()
        {
            ...
            if (timer == 1)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"Stellamod/Assets/Sounds/Zoee"), NPC.position);
            }
