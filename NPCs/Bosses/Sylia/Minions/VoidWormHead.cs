...
namespace Stellamod.NPCs.Bosses.Sylia.Minions
{
	// These three class showcase usage of the WormHead, WormBody and WormTail classes from Worm.cs
	internal class VoidWormHead : WormHead
	{
		public override int BodyType => ModContent.NPCType<VoidWormBody>();
		public override int TailType => ModContent.NPCType<VoidWormTail>();
	...
	internal class VoidWormBody : WormBody
	{
		public override void SetStaticDefaults()
		{
		...
		public override void Init()
		{
			VoidWormHead.CommonWormInit(this);
		}
	}

	internal class VoidWormTail : WormTail
	{
		public override void SetStaticDefaults()
		{
			NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers()
