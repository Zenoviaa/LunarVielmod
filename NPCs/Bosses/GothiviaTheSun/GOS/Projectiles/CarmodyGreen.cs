    ...
    public class CarmodyGreen : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Shooting == 1)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center.X, NPC.Center.Y, speedXb - 2 * 0, speedYb - 2 * 0, ModContent.ProjectileType<GREENLS>(), 1400, 0f, Main.myPlayer, 0f, ai1);
