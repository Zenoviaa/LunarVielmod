    ...
    public class Daedus : ModNPC
    {
        ...
        private void IdleDaed()
        {
            ...
            if (NPC.life < NPC.lifeMax / 2)
            {
                ...
                if (Timer2 == 50)
                {
                    ...
                    Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 50, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ProjectileID.GreekFire1, 5, 0f, 0, 0f, 0f);
                    Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 50, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ModContent.ProjectileType<SummonSpawnEffect>(), 0, 0f, 0, 0f, 0f);
                    Timer2 = 0;
        ...
        private void SummonLantern()
        {
            ...
            if (timer == 2)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 150, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ModContent.ProjectileType<SummonSpawnEffect>(), 0, 0f, 0, 0f, 0f);
        ...
        private void SummonVoid()
        {
            ...
            if (timer == 2)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 150, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ModContent.ProjectileType<VoidBomb>(), 0, 0f, 0, 0f, 0f);
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 150, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ModContent.ProjectileType<BouncySword>(), 30, 0f, 0, 0f, 0f);
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + 150, NPC.position.Y - 50, speedXb * 0, speedYb * 0, ModContent.ProjectileType<SummonSpawnEffect>(), 0, 0f, 0, 0f, 0f);
        ...
        private void SummonFlametornado()
        {
            ...
            if (timer == 2)
            {
                float speedXb = NPC.velocity.X * Main.rand.NextFloat(0f, 0f) + Main.rand.NextFloat(0f, 0f);
                float speedYb = NPC.velocity.Y * Main.rand.Next(0, 0) * 0.0f + Main.rand.Next(0, 0) * 0f;
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + speedXb + 140, NPC.position.Y + speedYb + 80, speedXb * 0, speedYb * 0, ModContent.ProjectileType<FlameTornado>(), 0, 0f, 0, 0f, 0f);
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position.X + speedXb + 140, NPC.position.Y + speedYb + 20, speedXb * 0, speedYb * 0, ModContent.ProjectileType<SummonSpawnEffect>(), 0, 0f, 0, 0f, 0f);
