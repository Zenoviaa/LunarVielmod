...
namespace Stellamod.NPCs.Bosses.Caeva
{
    internal class CaevaDeathRowR : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D4, NPC.Center - Main.screenPosition, null, new Color((int)(05f * alphaCounter), (int)(55f * alphaCounter), (int)(45f * alphaCounter), 0), -NPC.rotation, new Vector2(600, 44), 0.25f * (counter + 0.3f), SpriteEffects.None, 0f);
            return true;
        }
