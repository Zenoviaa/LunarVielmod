		...
		public class IshtarPersonProfile : ITownNPCProfile
		{
			...
			public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
			{
				if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
					return ModContent.Request<Texture2D>("Stellamod/NPCs/Town/Ishtar");

				if (npc.altTexture == 1)
					return ModContent.Request<Texture2D>("Stellamod/NPCs/Town/Ishtar_Head");

				return ModContent.Request<Texture2D>("Stellamod/NPCs/Town/Ishtar");
			}

			public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("Stellamod/NPCs/Town/Ishtar_Head");
		}
