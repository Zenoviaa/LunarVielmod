...
namespace Stellamod.NPCs.Underground
{
	public class Rustwork : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			NPC.aiStyle = 21; // This npc has a completely unique AI, so we set this to -1. The default aiStyle 0 will face the player, which might conflict with custom AI code.
