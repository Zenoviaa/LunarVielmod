...
namespace Stellamod.Particles
{
	public class RainbowParticle : Particle
	{
		...
		{
			Texture2D tex = (Texture2D)ModContent.Request < Texture2D > ("ParticleLibrary/Particles/RainbowParticle1");
			...
			spriteBatch.Draw((Texture2D)ModContent.Request<Texture2D>("ParticleLibrary/Particles/RainbowParticle2"), position - Main.screenPosition, new Rectangle(0, 0, 142, 42), color, ai[3].InRadians().AngleLerp((ai[3] + 90f).InRadians(), (120f - timeLeft) / 120f), new Vector2(71, 21), 0.75f * scale, SpriteEffects.None, 0f);
			spriteBatch.Draw((Texture2D)ModContent.Request<Texture2D>("ParticleLibrary/Particles/RainbowParticle3"), position - Main.screenPosition, new Rectangle(0, 0, 512, 512), color, ai[3].InRadians().AngleLerp((ai[3] + 90f).InRadians(), (120f - timeLeft) / 120f), new Vector2(256, 256), 0.25f * scale, SpriteEffects.None, 0f);
