...
namespace Stellamod.Particles
{
    public class ChromaSlash : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex3 = Request<Texture2D>("Stellamod/Particles/ChromaSlash").Value;
            Texture2D tex4 = Request<Texture2D>("Stellamod/Particles/ChromaSlashOpp").Value;
            ...
            {
                spriteBatch.Draw(tex4, Center - Main.screenPosition, tex4.AnimationFrame(ref frameCount, ref frameTick, 2, 7, true), color, velocity.ToRotation() + 180, new Vector2(300f, 300f) * 0.5f, 3f * Scale, spriteEffects, 0f);


            }
            else
            {
                spriteBatch.Draw(tex3, Center - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 2, 7, true), color, velocity.ToRotation() + 180, new Vector2(300f, 300f) * 0.5f, 3f * Scale, spriteEffects, 0f);
