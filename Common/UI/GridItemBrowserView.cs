...
namespace Stellamod.Common.UI
{
    ...
    /// </summary>
    public sealed class GridItemBrowserView : UIPanel
    {
            ...
            Func<Item, bool> viewFunction)
        {
            ...
            //Setup drawing
            SlotTextureAsset = slotTextureAsset;
            Width.Set(32, 0f);
            Height.Set(32, 0f);
        ...
        {
            return _oldSearchFilter != SearchFilter || SearchFilterItems == null;
        }
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            Rectangle outerDimensions = new Rectangle(0, 0, 48, 48);
            ...
            for (int i = startIndex; i < endIndex && i < itemArr.Length; i++)
            {
                ...
                Rectangle hoverRectangle = new Rectangle((int)tl.X, (int)tl.Y, 48, 48);
