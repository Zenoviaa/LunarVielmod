...
public class BossPageUI : RightPageUI
{
    ...
    public void SetBossPage(BossPage bossPage)
    {
        ...
        _generalRewardsUI.RewardsUI.SetBossPage(bossPage);
        _masterRewardsUI.RewardsUI.SetBossPage(bossPage);
        _noHitRewardsUI.RewardsUI.SetBossPage(bossPage);
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if(Page != 2)
        {
            _generalRewardsUI.Top.Pixels = 999999;
        }
        _generalRewardsUI.Left.Pixels = 16;
    ...
    public void ToggleRewardsWindow(UIMouseEvent evt, UIElement listeningElement)
    {
        _pageText.SetText(string.Empty);
        Page = 2;
    }
