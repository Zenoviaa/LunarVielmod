...
namespace Stellamod.Projectiles
{
    public class MorrowShot : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY, ProjectileID.DiamondBolt, (int)(Projectile.damage * 1.5), 0f, Projectile.owner, 0f, 0f);
            Projectile.Kill();
        }
        ...
        {
            //return Color.White;
            return new Color(26, 38, 22, 0) * (1f - (float)Projectile.alpha / 255f);
        }
