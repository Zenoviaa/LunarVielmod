    ...
    public override void AI()
    {
        ...
        if (Explosion > 179)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, speedX, speedY, ModContent.ProjectileType<SHShot>(), Projectile.damage * 1, 0f, Projectile.owner, 0f, 0f);
