...
public class VoltingShot : ModProjectile
{
    ...
    {
        return Color.Lerp(Color.LightGreen, Color.Transparent, completionRatio) * 0.7f;
    }
    ...
    private void DrawPixelatedBloomTrail(GraphicsDevice gDevice)
    {
        ...
        laserShader.OuterColor = Color.DarkGreen;
        laserShader.InnerColor = Color.Green;
        ...
        bloomTrail.InnerColor = Color.LightGreen;
        bloomTrail.OuterColor = Color.Green;
    ...
    private void DrawPixelatedFlash(SpriteBatch sb, Vector2 sp)
    {
        ...
        drawer.color = Color.Lerp(Color.LightGreen * 0.5f, Color.LightGreen, ExtraMath.Osc(0f, 1f, speed: 3));
        drawer.color.A = 0;
        sb.Draw(drawer);
