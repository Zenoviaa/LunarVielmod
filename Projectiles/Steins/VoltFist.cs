        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (!bounced)
            {
                ...
                for (int k = 0; k < 7; k++)
                {
                    ...
                    Dust.NewDustPerfect(player.Center + offset * 43, ModContent.DustType<TSmokeDust>(), Vector2.UnitY * -2 + offset.RotatedByRandom(spread), 150, Color.LightGoldenrodYellow * 0.5f, Main.rand.NextFloat(0.5f, 1));
