...
public class GreatShot : ModProjectile
{
    ...
    private void DrawPixelatedBloomTrail(GraphicsDevice gDevice)
    {
        ...
        laserShader.LaserColor = Color.LightYellow;
        ...
        bloomTrail.InnerColor = Color.LightYellow;
        bloomTrail.OuterColor = Color.Yellow;
    ...
    private void DrawPixelatedFlash(SpriteBatch sb, Vector2 sp)
    {
        ...
        drawer.color = Color.Lerp(Color.Yellow * 0.5f, Color.Yellow, ExtraMath.Osc(0f, 1f, speed: 3));
        drawer.color.A = 0;
        sb.Draw(drawer);
