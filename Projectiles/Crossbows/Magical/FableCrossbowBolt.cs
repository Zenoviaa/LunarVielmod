...
namespace Stellamod.Projectiles.Crossbows.Magical
{
    public class FableCrossbowBolt : ModProjectile
    {
...

        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedX * 0, speedY * 0, ModContent.ProjectileType<AlcadizBombExplosion>(), (int)(Projectile.damage * 2), 0f, Projectile.owner, 0f, 0f);
