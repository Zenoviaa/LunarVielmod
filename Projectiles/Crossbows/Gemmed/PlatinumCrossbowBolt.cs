...
namespace Stellamod.Projectiles.Crossbows.Gemmed
{
    public class PlatinumCrossbowBolt : ModProjectile
    {
...

        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX, speedY * 0.5f, ProjectileID.RubyBolt, (int)(Projectile.damage * 1), 0f, Projectile.owner, 0f, 0f);
