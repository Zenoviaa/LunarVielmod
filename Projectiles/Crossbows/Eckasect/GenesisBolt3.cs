...
namespace Stellamod.Projectiles.Crossbows.Eckasect
{
    public class GenesisBolt3 : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle($"Stellamod/Assets/Sounds/Starexplosion"), Projectile.position);
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX * 0, speedY * 0, ModContent.ProjectileType<GenesisBoom3>(), Projectile.damage * 2, 0f, Projectile.owner, 0f, 0f);
            Projectile.Kill();
            return false;
        }
