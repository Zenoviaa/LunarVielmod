    ...
    public class DeathShotProj : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
                Projectile.NewProjectile(EntitySource, Projectile.Center.X, Projectile.Center.Y, 0, 0, ModContent.ProjectileType<DeathShotBomb>(), Projectile.damage, 1, Projectile.owner, 0, 0);
