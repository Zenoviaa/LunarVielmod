            ...
            if (foundTarget)
            {
                ...
                if (distanceFromTarget > 40f)
                {
                    ...
                    if (Projectile.ai[1] >= 30)
                    {
                        ...
                        {
                            Projectile.NewProjectile(EntitySource, Projectile.Center.X, Projectile.Center.Y, direction.X * 25, direction.Y * 25, ProjectileType<GintzeSpearMini>(), 10, 1, Projectile.owner, 0, 0);
                        }
                        Projectile.ai[1] = 0;
                    }
