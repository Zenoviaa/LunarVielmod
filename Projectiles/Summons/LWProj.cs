...
namespace Stellamod.Projectiles.Summons
{
	...
	public class LWProj : ModProjectile
	{
		...
		public override void AI()
        {
            ...
            {
                owner.ClearBuff(BuffType<LifeWandMinionBuff>());
            }
            if (owner.HasBuff(BuffType<LifeWandMinionBuff>()))
            {
			...
			if (Heart == 400)
            {
				...
				Item.NewItem(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(10, 10), ItemID.Heart, 1);
