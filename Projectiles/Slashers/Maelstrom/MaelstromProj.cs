...
namespace Stellamod.Projectiles.Slashers.Maelstrom
{
    public class MaelstromProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex2 = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/SmooothTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/SmooothTrail").Value;
