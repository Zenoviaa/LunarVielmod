...
namespace Stellamod.Projectiles.Slashers.Ixy
{
    public class IxyProj2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!_initialized && Main.myPlayer == Projectile.owner)
            {
                ...
                SwingTime = (int)(30 / player.GetAttackSpeed(DamageClass.Magic));
            ...
            else if (_initialized)
            {
                ...
                if (!ParticleSpawned)
                {
                    ...
                    ParticleManager.NewParticle(player.Center, player.DirectionTo(Main.MouseWorld), ParticleManager.NewInstance<IxySlash>(), Color.Purple, 0.7f, Projectile.whoAmI, Projectile.whoAmI);
