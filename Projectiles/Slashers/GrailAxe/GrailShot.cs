    ...
    internal class GrailShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] == 160)
            {
                ...
                {
                    Projectile.NewProjectile(EntitySource, Projectile.Center.X, Projectile.Center.Y, 0, 0, ModContent.ProjectileType<KaBoomMagic2>(), Projectile.damage, 1, Main.myPlayer, 0, 0);
                }
