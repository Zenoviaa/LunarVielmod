...
namespace Stellamod.Projectiles.Slashers.SingularDive
{
    public class SingularDiveProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var TrailTex2 = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/WhiteTrail").Value;
            var TrailTex3 = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/WhiteTrail").Value;
            var TrailTex4 = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/WhiteTrail").Value;
