	...
	public class RhamenthalProjHold : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Timer == 75)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX * 1f, speedY, ModContent.ProjectileType<RhamenthalShot>(), (int)(Projectile.damage * 1), 0f, Projectile.owner, 0f, 0f);
