...
namespace Stellamod.Projectiles.Nails
{
	public class SteamedNailProj2 : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + speedX, Projectile.position.Y + speedY, speedX * 3, speedY * 3, ProjectileID.StarAnise, (int)(Projectile.damage * 1), 0f, Projectile.owner, 0f, 0f); ;
			Projectile.Kill();
