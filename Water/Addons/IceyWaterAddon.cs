...
namespace Stellamod.Water
{
    ...
    {
        public static ScreenTarget BackTarget = new(RenderFront, () => true, 1, (a) => Main.waterTarget.Size());
        public static ScreenTarget FrontTarget = new(RenderBack, () => true, 1, (a) => Main.instance.backWaterTarget.Size());
