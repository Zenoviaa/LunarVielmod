        ...
        public override void Load()
        {
         ...
         //   Filters.Scene["Stellamod:NaxtrinSky"] = new Filter(new ScreenShaderData(NaxtrinShader, "ShaderPass"), EffectPriority.VeryHigh);
          //  Filters.Scene["Stellamod:NaxtrinSky"].Load();
            ...
            Filters.Scene["Stellamod:Illuria"] = new Filter(new AuroreanStarsScreenShaderData("FilterMiniTower").UseColor(1.3f, -0.3f, 1.0f).UseOpacity(0.275f), EffectPriority.Medium);
