...
public class CauldronUISystem : BaseUISystem
{
    ...
    public void CloseUI()
    {
        ...
        cauldronUIState.cauldronUI.moldSlot.Item.SetDefaults(ItemID.None);

        cauldronUIState.cauldronUI.moldSlot2.Item = new Item();
        cauldronUIState.cauldronUI.moldSlot2.Item.SetDefaults(ItemID.None);
        if (!material.IsAir)
        {
            ...
            cauldronUIState.cauldronUI.materialSlot.Item.SetDefaults(ItemID.None);
        }
    }
