...
namespace Stellamod.Content.Vanity.SolsticeWarrior;


public class SolsticeWarriorHeadDrawLayer : PlayerDrawLayer
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        _hatTextureAsset = 
            ModContent.Request<Texture2D>(
                ModContent.GetInstance<SolsticeWarriorHead>().Texture);
    }
    ...
    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
    {
        return drawInfo.drawPlayer.head == 
            ModContent.GetInstance<SolsticeWarriorHead>().Item.headSlot;
...
public class SolsticeWarriorRobeDrawLayer : PlayerDrawLayer
{
    ...
    {
        base.SetStaticDefaults();
        _robeTextureAsset = ModContent.Request<Texture2D>(ModContent.GetInstance<SolsticeWarriorBody>().Texture);
    }
    public override void Unload()
    {
        base.Unload();
    ...
    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
    {
        return drawInfo.drawPlayer.body == ModContent.GetInstance<SolsticeWarriorBody>().Item.bodySlot;
...
public class SolsticeWarriorLegs : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
...
public class SolsticeWarriorHead : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
...
public class SolsticeWarriorBody : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
