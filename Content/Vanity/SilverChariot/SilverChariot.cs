...
namespace Stellamod.Content.Vanity.SilverChariot;

public class SilverChariotHeadDrawLayer : PlayerDrawLayer
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        _hatTextureAsset =
            ModContent.Request<Texture2D>(
                ModContent.GetInstance<SilverChariotHead>().Texture);
    }
    ...
    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
    {
        return drawInfo.drawPlayer.head ==
            ModContent.GetInstance<SilverChariotHead>().Item.headSlot;
...
public class SilverChariotBodyDrawLayer : PlayerDrawLayer
{
    ...
    {
        base.SetStaticDefaults();
        _robeTextureAsset = ModContent.Request<Texture2D>(ModContent.GetInstance<SilverChariotBody>().Texture);
    }
    public override void Unload()
    {
        base.Unload();
    ...
    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
    {
        return drawInfo.drawPlayer.body == ModContent.GetInstance<SilverChariotBody>().Item.bodySlot;
...
public class SilverChariotLegs : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
...
public class SilverChariotHead : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
...
public class SilverChariotBody : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
