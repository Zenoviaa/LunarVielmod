...
namespace Stellamod.Content.Vanity.GustbeakHat;

public class GustbeakHatDrawLayer : PlayerDrawLayer
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        _hatTextureAsset =
            ModContent.Request<Texture2D>(
                ModContent.GetInstance<GustbeakHat>().Texture + "_Hat");
    }
    ...
    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
    {
        return drawInfo.drawPlayer.head ==
            ModContent.GetInstance<GustbeakHat>().Item.headSlot;
...
public class GustbeakHat : ModItem
{
    public override void SetStaticDefaults()
    {
        base.SetStaticDefaults();
