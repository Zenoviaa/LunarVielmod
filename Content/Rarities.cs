...
namespace Stellamod.Content
{
    ...
    public class MinersGoldRarity : ModRarity
    {
    ...
    public class MusicalHarmoniseRarity : ModRarity
    {
    ...
    public class MothlightWingRarity : ModRarity
    {
        public override Color RarityColor => Color.Goldenrod;
        public override int GetPrefixedRarity(int offset, float valueMult)
        {
            if (offset > 0)
            { // If the offset is 1 or 2 (a positive modifier).
    ...
    public class GhastlySpiritRarity : ModRarity
    {
        public override Color RarityColor => Color.GhostWhite;
        public override int GetPrefixedRarity(int offset, float valueMult)
        {
            if (offset > 0)
            { // If the offset is 1 or 2 (a positive modifier).
