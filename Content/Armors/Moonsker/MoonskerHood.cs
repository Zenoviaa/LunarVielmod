...
namespace Stellamod.Content.Armors.Moonsker
{
    ...
    public class MoonskerHoodDrawLayer : PlayerDrawLayer
    {
        ...
        {
            base.SetStaticDefaults();
            _hatTextureAsset = ModContent.Request<Texture2D>(ModContent.GetInstance<MoonskerHood>().Texture + "_Hat");
        }
        ...
        {
            return drawInfo.drawPlayer.head == ModContent.GetInstance<MoonskerHood>().Item.headSlot;
