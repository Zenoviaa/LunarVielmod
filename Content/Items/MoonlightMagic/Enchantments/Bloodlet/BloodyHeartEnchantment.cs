...
namespace Stellamod.Content.Items.MoonlightMagic.Enchantments.Bloodlet
{
    public class BloodyHeartEnchantment : BaseEnchantment
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            double startAngle = System.Math.Atan2(1, 0) - spread / 2;
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, (float)(System.Math.Sin(offsetAngle) * Speed), (float)(System.Math.Cos(offsetAngle) * Speed), ProjectileID.VampireHeal, 16, 0, Projectile.owner);
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, (float)(-System.Math.Sin(offsetAngle) * Speed), (float)(-System.Math.Cos(offsetAngle) * Speed), ProjectileID.VampireHeal, 16, 0, Projectile.owner);
