...
{
    public class CoagulateEnchantment : BaseEnchantment
    {
    ...
    public class CoagulateEnchantmentExplosion : BaseSpikeAuraExplosionProjectile
    {
        int rStart = 4;
        int rEnd = 128;
        ...
        protected override float RadiusFunction(float completionRatio)
        {
            ...
            return MathHelper.Lerp(rStart, rEnd, EasingFunction.QuadraticBump(completionRatio));
        }
