...
{
    public class FlameLashEnchantment : BaseEnchantment
    {
    ...
    public class FlameLashEnchantmentExplosion : BaseExplosionProjectile
    {
        int trailMode;
        int rStart = 4;
        int rEnd = 128;
        ...
        protected override float RadiusFunction(float p)
        {
            ...
            return MathHelper.Lerp(rStart, rEnd, EasingFunction.OutCirc(p));
        }
