...
{
    public class HallowPurpleEnchantment : BaseEnchantment
    {
    ...
    public class HallowPurpleEnchantmentExplosion : BaseExplosionProjectile
    {
        ...
        protected override float BeamWidthFunction(float p)
        {
            ...
            float fadeWidth = MathHelper.Lerp(0, trailWidth, EasingFunction.OutExpo(p)) * Main.rand.NextFloat(0.85f, 1.0f);
            return fadeWidth;
        }
        ...
        protected override float RadiusFunction(float p)
        {
            ...
            return MathHelper.Lerp(rStart, rEnd, EasingFunction.InQuint(p));
        }
