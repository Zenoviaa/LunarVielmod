...
{
    public class HexCloudEnchantment : BaseEnchantment
    {
    ...
    public class HexCloudEnchantmentExplosion : BaseExplosionProjectile
    {
        int trailMode;
        int rStart = 4;
        int rEnd = 128;
        ...
        protected override float RadiusFunction(float p)
        {
            ...
            return MathHelper.Lerp(rStart, 100, EasingFunction.OutCirc(p));
        }
