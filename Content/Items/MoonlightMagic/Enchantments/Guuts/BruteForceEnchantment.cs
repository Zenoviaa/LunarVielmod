...
{
    public class BruteForceEnchantment : BaseEnchantment
    {
    ...
    public class BruteForceEnchantmentExplosion : BaseSpikeAuraExplosionProjectile
    {
        int rStart = 4;
        int rEnd = 128;
        ...
        protected override float RadiusFunction(float completionRatio)
        {
            ...
            return MathHelper.Lerp(rStart, rEnd, EasingFunction.OutCirc(completionRatio));
        }
