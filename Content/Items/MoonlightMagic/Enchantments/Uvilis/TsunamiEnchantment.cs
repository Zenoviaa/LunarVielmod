...
{
    public class TsunamiEnchantment : BaseEnchantment
    {
    ...
    public class TsunamiEnchantmentExplosion : BaseExplosionProjectile
    {
        int trailingMode;
        int rStart = 4;
        int rEnd = 128;
        ...
        protected override float RadiusFunction(float p)
        {
            ...
            return MathHelper.Lerp(rStart, rEnd, EasingFunction.OutCirc(p));// * MathUtil.Osc(0.75f, 1f, speed:12 , offset: p * 4);
        }
