...
{
    public class AdvancedMagicStaffProjectile : ModProjectile
    {
            ...
            ref float swingProgress)
        {
            ...
            swingProgress = EasingFunction.InOutExpo(lerpValue);
        }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Rectangle sourceRectangle = new Rectangle(0, startY, texture.Width, frameHeight);
            Vector2 origin = sourceRectangle.Size() / 2f;
            Color drawColor = Color.White * EasingFunction.QuadraticBump(1f - _smoothedLerpValue);
        ...
        private float WidthFunction(float p)
        {
            ...
            float fadeWidth = MathHelper.Lerp(trailWidth, 0, _smoothedLerpValue) * EasingFunction.OutExpo(_smoothedLerpValue);
            return fadeWidth;
        }
