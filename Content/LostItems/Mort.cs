...
namespace Stellamod.Content.LostItems
{
    ...
    public class MortBuff : ModBuff
    {
        ...
        { // This method gets called every frame your buff is active on your player.
            bool unused = false;
            player.BuffHandle_SpawnPetIfNeededAndSetTime(buffIndex, ref unused, ModContent.ProjectileType<Mort>());
        }
    }
    public class Mort : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<MortBuff>()))
            {
