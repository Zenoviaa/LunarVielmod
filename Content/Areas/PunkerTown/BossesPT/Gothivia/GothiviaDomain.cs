...
public class GothiviaDomain : ModSystem
{
    ...
    private bool ShouldRenderPlatforms() => drawGothivia;

    private bool ShouldRender() => drawGothivia && !ModContent.GetInstance<LunarVeilClientConfig>().FocusMode;
    ...
    private void DrawWind(SpriteBatch spriteBatch, Vector2 screenPos)
    {
        ...
        SpritebatchDrawer drawer = SpritebatchDrawer.FromTextureAsset(AssetReferences.Assets.NoiseTextures.BlurryPerlinNoise.Asset, Vector2.Zero);
    ...
    private void PrepareDomainContent(RenderTargetHandle domainRT, RenderTargetHandle domainSwapRT)
    {
        ...
        using (RT.Clear(domainRT, Color.Lerp(Color.Red, Color.Black, 0.9f)))
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearWrap, DepthStencilState.None, RasterizerState.CullNone, fireShader.Effect);
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearWrap, DepthStencilState.None, RasterizerState.CullNone, smokeShader.Effect);
        ...
        using(RT.Clear(domainSwapRT, Color.Lerp(Color.Red, Color.Black, 0.9f)))
        {
            ...
            spriteBatch.Draw(domainRT, Vector2.Zero, Color.White);
            spriteBatch.End();
        }
    ...
    private void DrawBlack(On_Main.orig_DrawNPCs orig, Main self, bool behindTiles)
    {
        ...
        if (ShouldRender())
        {
            ...
            drawColor2 *= 1f;
            spriteBatch.Draw(domainRT, new Rectangle(0, 0, Main.screenWidth * 2, Main.screenHeight * 2), drawColor2);
        ...
        if (ShouldRenderPlatforms())
        {
            ...
            if (singularityFallSystem.hoveringPlatform)
            {
                ...
                var bloomLine = AssetReferences.Assets.NoiseTextures.BloomLine.Asset;
