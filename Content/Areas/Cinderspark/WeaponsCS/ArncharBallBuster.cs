...
namespace Stellamod.Content.Areas.Cinderspark.WeaponsCS
{
    public class FireballShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer % 2 == 0)
            {
                Vector2 spawnPoint = Projectile.Center + Main.rand.NextVector2CircularEdge(80, 80);
        ...
        public override void AI()
        {
            ...
            if (this.OwnedByLocalClient() && !Owner.channel)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity,
                    ModContent.ProjectileType<FireballShot>(), damage, Projectile.knockBack, Projectile.owner);
            }
            ...
            _charge = MathHelper.Clamp(0f, 1f, Timer / 120f);
