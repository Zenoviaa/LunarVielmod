...
public class StoneGolett : ModItem
{
...
public class StoneGolettPet : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (!player.dead && player.HasBuff(ModContent.BuffType<StoneGolettPetBuff>()))
        {
            Projectile.timeLeft = 2;
        }
    }
}
public class StoneGolettPetBuff : ModBuff
{
    public override void SetStaticDefaults()
    {
    ...
    { // This method gets called every frame your buff is active on your player.
        bool unused = false;
        player.BuffHandle_SpawnPetIfNeededAndSetTime(buffIndex, ref unused, ModContent.ProjectileType<StoneGolettPet>());
    }
}