...
public class RagingIceTorch : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.DefaultToTorch(ModContent.TileType<RagingIceTorchTile>(), 0, false);
        Item.value = 50;
    }
    ...
    public override void HoldItem(Player player)
    {
        ...
        Lighting.AddLight(position, 0.3f, 0.3f, 1f);
    }
    ...
    public override void PostUpdate()
    {
        ...
        if (!Item.wet)
        {
            Lighting.AddLight(Item.Center, 0.3f, 0.3f, 1f);
        }
    }
...
public class RagingIceTorchTile : ModTile
{
    public override void SetStaticDefaults()
    {
        // Properties
    ...
    public override float GetTorchLuck(Player player)
    {
        ...
        bool inExampleUndergroundBiome = player.ZoneSnow;
    ...
    public override void EmitParticles(int i, int j, Tile tile, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
    {
        ...
        if (tile.TileFrameX < 66)
        {
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                factory.outerColor = Color.DarkBlue.ToVector4();
