    ...
    IDrawToRenderTarget
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            Dust.NewDustPerfect(Projectile.Center, ModContent.DustType<SmokeDust>(), Projectile.velocity.RotatedByRandom(MathHelper.ToRadians(30)) * Main.rand.NextFloat(0.2f, 1f), 0, Color.Red, 1f).noGravity = true;
        }
    }
