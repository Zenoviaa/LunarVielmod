...
public class GoldenFork : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<GoldenForkPet>(); // "Shoot" your pet projectile.
        Item.buffType = ModContent.BuffType<GoldenForkPetBuff>(); // Apply buff upon usage of the Item.
    }
...
public class GoldenForkPet : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (!player.dead && player.HasBuff(ModContent.BuffType<GoldenForkPetBuff>()))
        {
            Projectile.timeLeft = 2;
        }
    }
}
public class GoldenForkPetBuff : ModBuff
{
    public override void SetStaticDefaults()
    {
    ...
    { // This method gets called every frame your buff is active on your player.
        bool unused = false;
        player.BuffHandle_SpawnPetIfNeededAndSetTime(buffIndex, ref unused, ModContent.ProjectileType<GoldenForkPet>());
    }
}