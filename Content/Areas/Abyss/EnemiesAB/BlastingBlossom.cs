...
namespace Stellamod.Content.Areas.Abyss.EnemiesAB;
...
internal class BlastingBlossom : ModNPC
{
    ...
    {
        NPC.GetGlobalNPC<AnimatorGlobalNPC>().PreDraw(NPC, spriteBatch, Main.screenPosition, _outliner.outlineColor);
    }
