	...
	public class GovheilBows: ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (TimerShoot >= 100)
            {
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, speedXa * 5f, speedYa * 1.4f, ModContent.ProjectileType<GovheilBowsProj>(), (int)(Projectile.damage), 0f, Projectile.owner, 0f, 0f);
