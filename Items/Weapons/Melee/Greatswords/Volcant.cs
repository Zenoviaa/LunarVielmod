...
using System.IO;
using Stellamod.Projectiles.Slashers.Volcant;
...
namespace Stellamod.Items.Weapons.Melee.Greatswords
{
    public class Volcant : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("Stellamod/Assets/Sounds/SwingyLong") { Pitch = Main.rand.NextFloat(-10f, 10f) }, player.Center);
