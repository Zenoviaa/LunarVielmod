...
namespace Stellamod.Items.Weapons.Melee.Safunais
{
    public class Rinavine : BaseSafunaiItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            line = new TooltipLine(Mod, "Parandinea", Helpers.LangText.Core("Safunai"))
            {
        ...
        {
            base.AddRecipes();
            this.RegisterBrew(mold: ModContent.ItemType<BlankSafunai>(), material: ModContent.ItemType<GrailBar>());
        }
    }
}
