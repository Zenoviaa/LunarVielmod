...
namespace Stellamod.Items.Weapons.Summon
{
	...
	public class TheBurningRod : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<TheBurningRodBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ProjectileType<TheBurningRodMinion>();
		}
		...
		public class TheBurningRodBuff : ModBuff
		{
			public override void SetStaticDefaults()
			{
				// DisplayName.SetDefault("HMMinionBuff");
			...
			{
				if (player.ownedProjectileCounts[ProjectileType<TheBurningRodMinion>()] > 0)
				{
		 ...
		 * If it isn't attacking, it will float near the player with minimal movement
		 */
		public class TheBurningRodMinion : ModProjectile
		{
			public override void SetStaticDefaults()
			{
			...
			public override void AI()
			{
				...
				{
					player.ClearBuff(BuffType<TheBurningRodBuff>());
				}
				if (player.HasBuff(BuffType<TheBurningRodBuff>()))
				{
