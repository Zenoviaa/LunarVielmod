...
namespace Stellamod.Items.Weapons.Summon
{
    ...
    public class ArncharMinionBuff : ModBuff
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Arnchar Drone");
			// Description.SetDefault("The Arnchar Drone will fight for you");
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<ArncharMinion>()] > 0)
			{
	...
	public class ArncharRemote : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<ArncharMinionBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ProjectileType<ArncharMinion>();
		}
		 ...
		 */
		public class ArncharMinion : ModProjectile
		{
			public override void SetStaticDefaults()
			{
				// DisplayName.SetDefault("Arnchar Drone");
            ...
            public override void AI()
			{
				...
				{
					player.ClearBuff(BuffType<ArncharMinionBuff>());
				}
				if (player.HasBuff(BuffType<ArncharMinionBuff>()))
				{
