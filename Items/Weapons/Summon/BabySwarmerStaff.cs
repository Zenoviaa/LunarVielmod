...
namespace Stellamod.Items.Weapons.Summon
{
    ...
    public class BabySwarmerMinionBuff : ModBuff
    {
        ...
        {
            if (player.ownedProjectileCounts[ModContent.ProjectileType<BabySwarmerMinion>()] > 0)
            {
    ...
    public class BabySwarmerStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BabySwarmerMinion>();
        }
    ...
    /*
        ...
        */
    public class BabySwarmerMinion : ModProjectile
    {
