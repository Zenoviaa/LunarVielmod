...
namespace Stellamod.Items.Weapons.Summon
{
	...
	public class FCBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<FCMinion>()] > 0)
			{
	 ...
	 */
	public class FCMinion : ModProjectile
	{
		public override void SetStaticDefaults()
		{
        ...
        public override void AI()
		{
			...
			{
				player.ClearBuff(BuffType<FCBuff>());
			}
			if (player.HasBuff(BuffType<FCBuff>()))
			{
