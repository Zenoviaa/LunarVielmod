...
using static Stellamod.Items.Weapons.Summon.SwarmerStaff;
...
namespace Stellamod.Items.Weapons.Summon
{
    ...
    public class SwarmerMinionBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<SwarmerMinion>()] > 0)
			{
	...
	public class SwarmerStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<SwarmerMinionBuff>();
		 ...
		 */
		public class SwarmerMinion : ModProjectile
		{
			public override void SetStaticDefaults()
			{
            ...
            public override void AI()
			{
				...
				{
					player.ClearBuff(BuffType<SwarmerMinionBuff>());
				}
				if (player.HasBuff(BuffType<SwarmerMinionBuff>()))
				{
                ...
                if (foundTarget)
                {
					...
					Vector2 UpPos;
					UpPos.X = targetCenter.X;
                    UpPos.Y = targetCenter.Y - 150;
