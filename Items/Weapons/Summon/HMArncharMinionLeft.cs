...
namespace Stellamod.Items.Weapons.Summon
{
    ...
    public class HMMinionBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<HMArncharMinionLeft>()] > 0)
			{
	 ...
	 */
	public class HMArncharMinionLeft : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(BuffType<HMMinionBuff>());
			}
			if (player.HasBuff(BuffType<HMMinionBuff>()))
			{
    ...
    public class HMArncharMinionRight : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("HMArncharMinion");
