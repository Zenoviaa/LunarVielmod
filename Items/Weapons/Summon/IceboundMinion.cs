...
namespace Stellamod.Items.Weapons.Summon
{
	...
	public class IceboundMinionBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<IceboundMinion>()] > 0)
			{
	...
	public class IceboundStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<IceboundMinionBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ProjectileType<IceboundMinion>();
		}
		 ...
		 */
		public class IceboundMinion : ModProjectile
		{
			public override void SetStaticDefaults()
			{
			...
			public override void AI()
			{
				...
				{
					player.ClearBuff(BuffType<IceboundMinionBuff>());
				}
				if (player.HasBuff(BuffType<IceboundMinionBuff>()))
				{
