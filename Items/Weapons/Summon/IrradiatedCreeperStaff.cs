...
using static Stellamod.Items.Weapons.Summon.IrradiatedCreeperStaff;
...
namespace Stellamod.Items.Weapons.Summon
{
	...
	public class IrradiatedCreeperBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ProjectileType<IrradiatedCreeper2>()] > 0)
			{
	...
	public class IrradiatedCreeperStaff : ModItem
	{
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = BuffType<IrradiatedCreeperBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ProjectileType<IrradiatedCreeper2>();
        }
		 ...
		 */
		public class IrradiatedCreeper2 : ModProjectile
		{
			public override void SetStaticDefaults()
			{
			...
			public override void AI()
			{
				...
				{
					player.ClearBuff(BuffType<IrradiatedCreeperBuff>());
				}
				if (player.HasBuff(BuffType<IrradiatedCreeperBuff>()))
				{
				...
				if (Main.rand.Next(3) == 1)
				{
					...
					int dust1 = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, 74, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
