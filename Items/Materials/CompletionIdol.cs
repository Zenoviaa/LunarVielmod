...
namespace Stellamod.Items.Materials
{
    ...
    public class DreadfulCompletionIdol : ModItem
    {
        ...
        public override void AddRecipes()
        {
            Recipe recipe2 = CreateRecipe(1);
       //     recipe2.AddIngredient(ModContent.ItemType<VeiledScriptureCozmire>(), 1);
            recipe2.AddIngredient(ModContent.ItemType<DreadFoil>(), 10);
            recipe2.Register();
        }
    }
    public class SuperCompletionIdol : ModItem
    {
    ...
    public class IrradiatedCompletionIdol : ModItem
    {
