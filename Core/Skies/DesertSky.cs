...
namespace Stellamod.Core.Skies
{
    public class DesertSky : CustomSky
    {
        ...
        {
            var texture = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/Clouds5");
            var colorMapTexture = ModContent.Request<Texture2D>("Stellamod/Assets/NoiseTextures/ColorMapYellow");
