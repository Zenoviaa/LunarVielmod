...
namespace Stellamod.Core.Helpers
{
    public static class VectorHelper
    {
        ...
        public static class Numbers
        {
            ...
            {
                double rad = mode == 0 ? System.Math.PI : mode == 1 ? System.Math.PI * 2 : System.Math.PI / 2;
                return (float)System.Math.Sin((Main.GlobalTimeWrappedHourly + differentiator * multiplier) % rad);
            }
        }
