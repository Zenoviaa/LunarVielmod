...
public readonly record struct RenderTargetContext2 : IDisposable
{
    private readonly RenderTargetBinding[] _oldBindings;
    private readonly GraphicsDevice _graphicsDevice;
    private readonly RenderTargetHandle _handle;
    public RenderTargetContext2(RenderTargetHandle handle, Color? clearColor = null, GraphicsDevice graphicsDevice = null) :
        this(new RenderTargetBinding[] { handle.Target }, clearColor, graphicsDevice)
    {
        _handle = handle;
    }

    public RenderTargetContext2(RenderTargetBinding[] bindings, Color? clearColor = null, GraphicsDevice graphicsDevice = null)
    {
