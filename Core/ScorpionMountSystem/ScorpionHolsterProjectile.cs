...
using Stellamod.Content.Items.Weapons.Ranged;
...
namespace Stellamod.Core.ScorpionMountSystem
{
    internal class ScorpionHolsterProjectile : ModProjectile
    {
        ...
        private void AI_Prepare()
        {
            ...
            float easedProgress = EasingFunction.OutCubic(progress);
        ...
        private void AI_Fire()
        {
            ...
            float easedProgress = EasingFunction.OutExpo(progress);
            ...
            Recoil = MathHelper.Lerp(0, MiniGun.RecoilDistance, EasingFunction.QuadraticBump(progress));
            if (Timer >= ExecTime)
            {
