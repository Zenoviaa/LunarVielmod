...
namespace Stellamod.Core.Visual.Particles
{
    ...
    {
        private GlowCircleShader _glowCircleShader;
        public float Timer;
        ...
        public override void OnSpawn()
        {
            ...
            BaseSize = 0.025f;
            Pixelation = 1f;
            customShader = _glowCircleShader = new GlowCircleShader();
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GlowCircleShader shader = _glowCircleShader;
            shader.Speed = 5;
            ...
            _glowCircleShader.ApplyToEffect();
