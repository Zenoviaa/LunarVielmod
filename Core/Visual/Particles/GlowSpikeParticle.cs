...
namespace Stellamod.Core.Visual.Particles
{
    ...
    {
        private GlowPillarShader _shader;
        public float Timer;
        ...
        public override void OnSpawn()
        {
            ...
            Pixelation = 1f;
            Height = 1.0f;
            customShader = _shader = new GlowPillarShader();
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GlowPillarShader shader = _shader;
            shader.Speed = 5;
            ...
            float s = BaseSize;
            shader.Size = MathHelper.Lerp(0, s * 2, EasingFunction.QuadraticBump(Progress));
            ...
            shader.Height = MathHelper.Lerp(0, Height, EasingFunction.QuadraticBump(Progress));
