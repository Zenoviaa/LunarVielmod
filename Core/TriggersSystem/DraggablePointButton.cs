...
{
    public class DraggablePointButton : UIPanel
    {
        ...
        private void OnButtonClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (TriggerSelector.DraggablePoint == DraggablePoint)
            {
                TriggerSelector.DraggablePoint = null;
            }
            else
            {
                TriggerSelector.DraggablePoint = DraggablePoint;
            }
