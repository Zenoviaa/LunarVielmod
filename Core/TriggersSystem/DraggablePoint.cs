...
{
    public class DraggablePoint : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (TriggerSelector.DraggablePoint != null)
            {
            ...
            if (_isDragging)
            {
                ...
                TriggerSelector.DraggablePoint.X = (int)roundedPoint.X / 16;
                TriggerSelector.DraggablePoint.Y = (int)roundedPoint.Y / 16;
            }
            else
            {
                Projectile.position.X = TriggerSelector.DraggablePoint.X * 16;
                Projectile.position.Y = TriggerSelector.DraggablePoint.Y * 16;
            }
