    ...
    internal class GunHolsterRightSlot : UIElement
    {
        ...
        internal GunHolsterRightSlot(int context = ItemSlot.Context.InventoryItem, float scale = 1f)
        {
            ...
            var asset = ModContent.Request<Texture2D>(
                $"Stellamod/Core/GunHolsterSystem/UI/RightSlot", ReLogic.Content.AssetRequestMode.ImmediateLoad);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            Texture2D backingTexture = ModContent.Request<Texture2D>($"Stellamod/Core/GunHolsterSystem/UI/RightSlot").Value;
