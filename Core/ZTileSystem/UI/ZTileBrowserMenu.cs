...
/// </summary>
public class ZTileBrowserMenu : UIPanel
{
    ...
    private ZTileBrowserView _view;
    public ZTileBrowserMenu(UIScrollbar scrollbar)
    {
    ...
    private void Refresh()
    {
        ...
        ZTile[] items = tileLoader.Tiles;
        _view = new ZTileBrowserView(items);
