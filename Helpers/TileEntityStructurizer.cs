...
/// <summary>
/// Reads and writes Z Tiles to a structure type file, with the file extension .ztl
/// Probably not the best way to do things, but it works.
/// </summary>
public static class ZTileStructurizer
{
    ...
    public static void SaveStruct(string fileName, Point bottomLeft, Point topRight)
    {
        ...
        Rectangle bounds = new Rectangle(bottomLeft.X, topRight.Y,
        ...
        stream.Flush();
        DebugHelper.NewTextOnlyInTesting("Z Tile Structure Saved");
    }
