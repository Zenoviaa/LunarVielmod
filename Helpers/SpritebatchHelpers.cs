...
namespace Stellamod.Helpers
{
    ...
    {
        public static void OutlineNoRestart(this ModProjectile modProj, Color color, ref Color lightColor, Vector2 scale)
        {
        ...
        public static void Outline(this ModProjectile modProj, Color color, ref Color lightColor, Vector2 scale)
        {
            Texture2D texture = ModContent.Request<Texture2D>(modProj.Texture).Value;
            Vector2 drawPos = modProj.Projectile.Center - Main.screenPosition;
            float outlineOffset = 2;
