...
namespace Stellamod.Tiles.Furniture
{
    ...
    public class IrradiaBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Stellamod/Tiles/Furniture/IrradiaBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.IrradiaBossRel>();
					break;
