...
namespace Stellamod.Tiles.Furniture
{
    ...
    public class SOMBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Stellamod/Tiles/Furniture/SOMBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.SOMBossRel>();
					break;
