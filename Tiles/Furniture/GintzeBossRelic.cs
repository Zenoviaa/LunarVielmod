...
namespace Stellamod.Tiles.Furniture
{
	...
	public class GintzeBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Stellamod/Tiles/Furniture/GintzeBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.GintzeBossRel>();
					break;
