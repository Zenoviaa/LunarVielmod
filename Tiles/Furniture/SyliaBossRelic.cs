...
namespace Stellamod.Tiles.Furniture
{
    ...
    public class SyliaBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Stellamod/Tiles/Furniture/SyliaBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.SyliaBossRel>();
					break;
