...
namespace Stellamod.Tiles.Furniture
{
	...
	public class VerliBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Stellamod/Tiles/Furniture/VerliBossRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.VerliBossRel>();
					break;
